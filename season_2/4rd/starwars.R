...
starwars |> distinct(sex)
  ...
  #7-1 relevel
starwars$sex |> 
  as_factor() #Levels: male none female hermaphroditic
...
starwars$sex |> 
  as_factor()  #Levels: female male none hermaphroditic
starwars
