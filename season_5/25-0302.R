...
ap_3arr_rename |> 
  full_join(ap_3dep_rename) -> ap_4join_tidy
...
#
ap_4join_tidy |> 
  select(날짜, 항공사, 편명, 출발공항명, 도착공항명, 계획시간, 실제시간, 구분, 현황, 출도착구분) |> 
  separate(col = 계획시간, into = c('계획시', '계획분'), sep = ":", remove = F) |> #print(n = 50)
...
ap_4join_tidy2 |> 
  ...
  select(날짜, 항공사, 편명, 출발공항명, 도착공항명, 
         계획시간, 실제시간, 계획, 실제, 구분, 현황, 출도착구분) -> ap_4join_tidy3
